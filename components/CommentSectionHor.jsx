...
const CommentSectionHor = ({postViewed,setCommentsOpen}) => {
  ...
  return (
    <div className="comment_box_hor">
        ...
        <div className='post_comments_content_hor'>
        ...
        <div className='post_comment_inp_hor'>
...
export default CommentSectionHor